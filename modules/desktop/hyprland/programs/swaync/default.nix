        ...
        style = ''
          @define-color shadow rgba(0, 0, 0, 0.35);
              ...
              */
              ...
              @define-color surface2 #665c54;

              @define-color overlay0 #7c6f64;
              @define-color overlay1 #928374;
              @define-color overlay2 #a89984;

              @define-color blue      #83a598;
              @define-color lavender  #d3869b;
              @define-color sapphire  #83a598;
              @define-color sky       #8ec07c;
              ...
              @define-color base_lighter  #3c3836;
              @define-color mauve_lighter #d3869b;

              /* GTK theme aliases used below */
              @define-color theme_bg_color #282828;
              @define-color theme_text_color #ebdbb2;
              @define-color theme_selected_bg_color #504945;
              @define-color theme_fg_color #fabd2f;
        * {
