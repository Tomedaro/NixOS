...
Use a local AI vault as the protocol, state, queue, event, and evidence layer.

## Consequences

Keeps the system inspectable, offline-capable, user-owned, and debuggable.
