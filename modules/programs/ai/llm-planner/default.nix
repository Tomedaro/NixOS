...
let
  ...
  plannerScript = pkgs.writeTextFile {
    name = "llm-planner";
    destination = "/bin/llm-planner";
    executable = true;
    ...
    text = ''
      ...
      Your job is to help Artem move toward his intended behavior with minimal active input.
      ...
      - whether to ask Artem a clarifying question
