...
ACTION_CAPABILITY_POLICY = {
    ...
    "check_in": {
        ...
        "status": "gated",
        "side_effect": "check_in_state",
        "default_enabled": True,
        "gate_env": "ALLOW_SESSION_CHECK_IN",
    ...
    "submit_proof": {
        ...
        "status": "gated",
        "side_effect": "proof_artifacts",
        "default_enabled": True,
        "gate_env": "ALLOW_PROOF_SUBMIT",
        "min_authority": 1,
    ...
    "promote_task_proposal": {
        ...
        "status": "disabled",
        "side_effect": "none_disabled_tasknotes",
