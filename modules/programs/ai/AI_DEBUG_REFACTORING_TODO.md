...
- [ ] Split or lower broad `actionBridge.authorityLevel` so ordinary actions do not imply TaskNotes promotion authority.
...
- [x] Align `obsidian_task_draft.v1` with the live TaskNotes config before designing the apply/promote gate.
