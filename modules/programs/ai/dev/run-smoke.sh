...
tests=(
  ...
  modules/programs/ai/tests/obsidian_ingress_smoke.py
  modules/programs/ai/tests/obsidian_intent_planner_smoke.py
  ...
  modules/programs/ai/tests/tasknotes_apply_validator_smoke.py
